# The name of this view in Looker is "A200 Energy Bill Forecast La V2"
view: a200_energy_bill_forecast_la_v2 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `utilitieshub-demo-sandbox.utilitieshubdataset.a200_energy_bill_forecast_la_v2`
    ;;
