# The name of this view in Looker is "A200 Ecp Certificates Lsoa Agg"
view: a200_ecp_certificates_lsoa_agg {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `utilitieshub-demo-sandbox.utilitieshubdataset.a200_ecp_certificates_lsoa_agg`
    ;;
